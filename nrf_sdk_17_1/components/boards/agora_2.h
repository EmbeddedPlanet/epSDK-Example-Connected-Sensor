 ...
 * @date    28 FEB 2025
 * 
 * @brief Contains definitions for Agora (DES0290_10) support
 * 
...
//GPIO voltage set in UICR register: 3V3
#define REQUIRED_UICR_REGOUT0_VOUT   UICR_REGOUT0_VOUT_3V3

// SDK LED definitions for Agora
#define LEDS_NUMBER    3

#define LED_1          NRF_GPIO_PIN_MAP(0,22)    //Agora 2.0 differs from Agora, red
#define LED_2          NRF_GPIO_PIN_MAP(0,23)   //New in Agora 2.0, Green 
#define LED_3          NRF_GPIO_PIN_MAP(0,21)    //New in Agora 2.0, Blue
...
#define CELL_PWR_EN                 NRF_GPIO_PIN_MAP(0, 4)  //Agora 2.0 differs from Agora
#define CELL_ON_OFF                 NRF_GPIO_PIN_MAP(0,19)  //Agora 2.0 differs from Agora
#define CELL_PWRMON                 NRF_GPIO_PIN_MAP(1,15) 
#define CELL_HW_SHUTDOWN            NRF_GPIO_PIN_MAP(0,24)
#define CELL_RX_PIN_NUMBER          NRF_GPIO_PIN_MAP(1, 1)
#define CELL_TX_PIN_NUMBER          NRF_GPIO_PIN_MAP(1,12)  //Agora 2.0 differs from Agora
#define CELL_RTS_PIN_NUMBER         NRF_GPIO_PIN_MAP(0,11)  //Agora 2.0 differs from Agora
#define CELL_CTS_PIN_NUMBER         NRF_GPIO_PIN_MAP(1, 8)
#define CELL_DTR_PIN_NUMBER         NRF_GPIO_PIN_MAP(1,14)  //Agora 2.0 differs from Agora
#define CELL_DSR_PIN_NUMBER         NRF_GPIO_PIN_MAP(1,13)  //Agora 2.0 differs from Agora
#define CELL_DCD_PIN_NUMBER         NRF_GPIO_PIN_MAP(0,15)

// Sensors (I2C)
#define PIN_NAME_SENSOR_POWER_ENABLE    NRF_GPIO_PIN_MAP(0,20)  //Agora 2.0 differs from Agora
#define PIN_NAME_SDA                    NRF_GPIO_PIN_MAP(0,26)
#define PIN_NAME_SCL                    NRF_GPIO_PIN_MAP(0,27)

// Miscellaneous I/O
#define PIN_NAME_PUSH_BUTTON        BUTTON_1
//#define PIN_NAME_LED_RED            BSP_LED_0
#define PIN_NAME_LED_RED          LED_1  //Red
#define PIN_NAME_LED_GRN          LED_2  //Green
#define PIN_NAME_LED_BLU          LED_3  //BLU
#define PIN_NAME_BT840_RESETN       NRF_GPIO_PIN_MAP(0,18)
#define PIN_NAME_BT840_SWO          NRF_GPIO_PIN_MAP(1, 0)
#define BAT_MON_EN_PIN              NRF_GPIO_PIN_MAP(0,14)  //Agora 2.0 differs from Agora
#define PIN_NAME_I2S_SCK            NRF_GPIO_PIN_MAP(0,17)  //Agora 2.0 differs from Agora

//QSPI I/O
#define BSP_QSPI_SCK_PIN    NRF_GPIO_PIN_MAP(0,30)   //Agora 2.0 differs from Agora
#define BSP_QSPI_CSN_PIN    NRF_GPIO_PIN_MAP(1, 9)   //Agora 2.0 differs from Agora
#define BSP_QSPI_IO0_PIN    NRF_GPIO_PIN_MAP(1, 3)   //Agora 2.0 differs from Agora
#define BSP_QSPI_IO1_PIN    NRF_GPIO_PIN_MAP(0,31)   //Agora 2.0 differs from Agora
#define BSP_QSPI_IO2_PIN    NRF_GPIO_PIN_MAP(0, 6)   //Agora 2.0 differs from Agora
#define BSP_QSPI_IO3_PIN    NRF_GPIO_PIN_MAP(0, 5)   //Agora 2.0 differs from Agora
...
#define PIN_NAME_TE_GPIO6   NRF_GPIO_PIN_MAP(1, 2)   //Added in Agora 2.0
#define PIN_NAME_TE_GPIO7   CELL_DSR_PIN_NUMBER      //Added in Agora 2.0
#define PIN_NAME_TE_GPIO8   CELL_DTR_PIN_NUMBER      //Added in Agora 2.0
#define PIN_NAME_TE_GPIO9   CELL_DCD_PIN_NUMBER      //Added in Agora 2.0

//Sensor Interrupts
#define PIN_NAME_INT_TOF    NRF_GPIO_PIN_MAP(0,28)   //Agora 2.0 differs from Agora
...
#define PIN_NAME_LORA_NSS   NRF_GPIO_PIN_MAP(1, 4)  //Agora 2.0 differs from Agora
#define PIN_NAME_LORA_NRST  NRF_GPIO_PIN_MAP(1,10)
#define PIN_NAME_LORA_DIO0  NRF_GPIO_PIN_MAP(1, 7)
#define PIN_NAME_LORA_DIO1  PIN_NAME_TE_GPIO6       //Agora 2.0 differs from Agora
#define PIN_NAME_LORA_DIO2  CELL_DSR_PIN_NUMBER
#define PIN_NAME_LORA_DIO3  CELL_DTR_PIN_NUMBER
...
//#define SER_CONN_CHIP_RESET_PIN     CELL_RX_PIN_NUMBER        // Pin used to reset connectivity chip
